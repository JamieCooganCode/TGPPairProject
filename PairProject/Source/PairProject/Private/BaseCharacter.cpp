...
void ABaseCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindAxis("Right Thumbstick Vertical", IE_Pressed, this, &ABaseCharacter::MoveForward);
	//PlayerInputComponent->BindAxis("Right Thumbstick Horizontal", IE_Pressed, this, &ABaseCharacter::MoveRight);
